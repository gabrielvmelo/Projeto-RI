...
class BuildTermIndex {
    private var tokensMap: HashMap<String, ArrayList<ByteArray>>? = null

    //conta a frequencia do token em relacao aos documentos
    private fun countFrequency(documentsList: ArrayList<HashMap<ByteArray, Int>>): Int{
        return documentsList.size
    }

    //povoa list de acordo com o map do tokenizer
    private fun createList(tokenList: ArrayList<ByteArray>): ArrayList<HashMap<ByteArray, Int>>{
        val documentsList = arrayListOf<HashMap<ByteArray, Int>>()
    ...
    fun build(tokensMap: HashMap<String, ArrayList<ByteArray>>): TermIndex{
        this.tokensMap = tokensMap //saida do tokenizer: String=token List=ids
        var documentsList: ArrayList<HashMap<ByteArray, Int>>

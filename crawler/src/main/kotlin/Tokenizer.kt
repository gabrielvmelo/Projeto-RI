...
class Tokenizer {
    val hashMap = hashMapOf(
            ...
            "game" to (-10), "author" to (-10), "vote" to (-10), "games" to (-20), "company" to (-20), "music" to (-30), "albums" to (-30), "donate" to (-30), "sponsors" to (-30), "contribute" to (-30),
            "showtimes" to (-20), "apps" to (-10), "sports" to (-30), "tech" to (-20), "community" to (-20), "trivia" to (-20), "characters" to (-10), "character" to (-10),

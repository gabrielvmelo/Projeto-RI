...
class PageClassifier {
    val hashMap = hashMapOf(
            "season" to 10, "seasons" to 10, "tv" to 5, "episodes" to 10, "series" to 10,"serie" to 10, "episode" to 10, "guide" to 5, "status" to 7, "returning" to 7,
            "ended" to 7, "show" to 10, "continuing" to 7, "info" to 3, "genre" to 3, "network" to 3, "premiere" to 3, "date" to 3, "exec" to 3,
            ...
            "airs" to 1, "premieres" to 1, "recent" to 1, "watchlist" to 1, "view" to 1, "premise" to 1, "full" to 1, "summary" to 1, "genre(s)" to 1, "credits" to 1,
            ...
            "sponsors" to (-5), "supporting" to (-5), "community" to (-5), "feed" to (-5), "near" to (-5), "sign" to (-5), "news" to (-1), "new" to (-1),
    ...
    fun scorePage(html: String): Int{
        ...
        val wordLimitMap = hashMapOf(
                ...
                "guide" to 30, "season" to 60, "date" to 60, "genres" to 50, "runtime" to 50
        )
